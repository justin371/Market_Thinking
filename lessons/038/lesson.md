...
## 本课目标
围绕《大回调趋势》建立一套可观察、可解释、可更新的判断框架。本课是课程初稿，后续会继续补充案例、图表和教师提示。
...
## 开放思考题
如果没有唯一答案，你会用哪些证据支持你对《大回调趋势》的解释？请同时写出一个反例和一个可能改变观点的新信息。

## AI 一起讨论
请 AI 先复述《大回调趋势》的问题，再提出三个不同情景；要求它标注证据、假设和无法确认的部分。
